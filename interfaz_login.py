...
fondo = CTkImage(Image.open(ruta_recurso(
    "carpeta_iconos/general/login.jpg")), size=(400, 450))
label_fondo = CTkLabel(ventana_login, image=fondo,
...
etiqueta_bienvenida = CTkLabel(
    frame, text="¡Bienvenido!", font=("Helvetica", 16), text_color="black")
etiqueta_bienvenida.pack(pady=(20, 5))

entry_usuario = CTkEntry(
    frame, width=220, placeholder_text="Ingrese su usuario")
...
boton_login = CTkButton(frame, text="Iniciar sesión",
                        command=on_login, fg_color="#314560")
