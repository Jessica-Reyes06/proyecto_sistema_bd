...
def obtener_grupos_ordenadas():
    ...
    id_grupo, nombre_maestro, nombre_materia, cupo_maximo, periodo, anio, inscritos, horario, estado
    Reemplaza matricula_maestro por nombre_maestro e id_materia por nombre_materia mediante JOIN"""
    sql = """
